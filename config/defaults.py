...
_C.DATALOADER.SAMPLER = "" # set it in the .yml file.
...
# test based on original IDs or new assigned IDs (pid+clothid)
_C.TEST.MODE = ''
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
# "assign_new_IDs" considers the pid+clothid as a new id (suitable for Network1)
_C.TRAIN_MODE = "" # assign_new_IDs | orig_IDs
_C.Train_on_ShortTerm_data = False
