...
class PRCC_noneID(BaseImageDataset):
    dataset_dir = cfg.DATASETS.ROOT_DIR

    def __init__(self,root='', verbose=True, **kwargs):
        super(PRCC_noneID, self).__init__()
        ...
        self.query_dir = osp.join(self.dataset_dir, 'test', 'C') # 'B' or 'C' for different clothes and same clothes, respectively
    ...
    # new id will be assigned: new_id=pid+clothid
